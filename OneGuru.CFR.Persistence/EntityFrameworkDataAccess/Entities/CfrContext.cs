...
namespace OneGuru.CFR.Persistence.EntityFrameworkDataAccess.Entities
{
    ...
    public partial class CfrContext : DbContext
    {
        private readonly HttpContext _httpContext;
        private readonly IConfiguration Configuration;
        private readonly ILogger<CfrContext> _logger;

        public CfrContext()
        {
        }

        public CfrContext(DbContextOptions<CfrContext> options, IConfiguration configuration, ILoggerFactory loggerFactory, IHttpContextAccessor httpContextAccessor = null)
            : base(options)
        {
            _httpContext = httpContextAccessor?.HttpContext;
            Configuration = configuration;
            _logger = loggerFactory.CreateLogger<CfrContext>();
        }

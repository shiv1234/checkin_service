...
namespace UnlockOKR.OKRSupoort.Persistence.EntityFrameworkDataAccess
{
    ...
    {
        protected readonly OkrSupportContext Context;
        private readonly DbSet<T> _dbSet;
        public Repository(OkrSupportContext context)
        {
        ...
        {
            if (entities == null) throw new ArgumentNullException($"{nameof(AddAsync)} entity must not be null");

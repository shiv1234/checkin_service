...
using Xunit;
using static OneGuru.CFR.Application.Filters.AuthorizationFilterAttribute;

namespace OneGuru.CFR.Application.Tests.Filters
{
    public class AuthorizationFilterAttributeTest
    {
        ...
        public void AuthorizeAction_AuthorizationFilterContextNotNull_UserIdentityNull_IsSuccess()
        {
            ...
            // Act
            var objAuthorizeAction = new AuthorizeAction(new OneGuru.CFR.Domain.Common.Permissions(), mockIServicesAggregator.Object, mockISystemService.Object);
            objAuthorizeAction.OnAuthorization(okjAuthorizationFilterContext);
        ...
        {
            // Act
            new AuthorizationFilterAttribute(new OneGuru.CFR.Domain.Common.Permissions());
        }
        #endregion
    }
}
